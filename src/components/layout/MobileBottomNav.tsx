...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({ onOpenMore, isMoreOpen = false }) => {
  ...
  // Bottom navigation is shown on mobile and tablet (< 1024px) for Trainee, Institute Admin, and Super Admin
  if (currentUser.role !== 'trainee' && currentUser.role !== 'institute_admin' && currentUser.role !== 'super_admin') return null;
