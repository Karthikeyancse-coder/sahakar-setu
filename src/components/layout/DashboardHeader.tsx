          ...
          <div className="flex items-center justify-between h-14 sm:h-16 gap-2">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2.5 flex-shrink-0">
              ...
              <button
                ...
                className={`hidden sm:flex p-1.5 sm:px-2.5 sm:py-1.5 rounded-lg border text-xs font-semibold items-center gap-1.5 transition-colors cursor-pointer min-h-[36px] ${
                  isOffline
              ...
              <button
                ...
                className={`hidden min-[420px]:flex items-center gap-1.5 p-1.5 sm:px-3 sm:py-1.5 rounded-lg border text-xs font-semibold shadow-xs transition-all cursor-pointer min-h-[36px] ${
                      ...
                      {notifications.length === 0 ? (
                        ...
                        notifications.map((notif) => (
                          <div
                            ...
                            className={`p-3.5 flex items-start gap-3 hover:bg-govTeal-50/50 cursor-pointer transition-colors ${
                              !notif.isRead ? 'bg-govTeal-50/20' : ''
                            }`}
                          >
